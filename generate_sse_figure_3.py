...
c=0
# 2a is maxima of full set of 50C boson data vs radius
axes[c].plot(orig_radii50, orig_cmaximas50, 'k.')
axes[c].legend([r"$T_{T}$ = 50$^\circ$C"], fontsize=14)
axes[c].grid(True)
...
c=1
tgt50 = np.polyfit(1/np.power(orig_radii50[orig_radii50>2.75], 0.5), orig_cmaximas50[orig_radii50>2.75], 1)[1]
axes[c].plot(orig_radii50, tgt50 - orig_cmaximas50, 'k.')
axes[c].legend([r"$T_{T}$ = 50$^\circ$C"], fontsize=14)
axes[c].grid(True)
...
c=2
axes[c].plot(orig_radii50, pcts50, 'k.')
axes[c].legend([r"$T_{T}$ = 50$^\circ$C"], fontsize=14)
