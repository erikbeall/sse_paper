...
# figure 10 shows correction effect in same selected lens
# appendix shows all the rest

[radii35, maximas35, cbgs35, maximas35_c, bgs35_c] = np.load('results_stage2_lens_umi_35C.npy')
[radii50, maximas50, cbgs50, maximas50_c, bgs50_c] = np.load('results_stage2_lens_umi_50C.npy')
[radii80, maximas80, cbgs80, maximas80_c, bgs80_c] = np.load('results_stage2_lens_umi_80C.npy')
